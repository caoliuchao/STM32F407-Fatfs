...
void  elapsed_time_init (void)         
{
    ...
    if (BSP_REG_DWT_CR != 0)  // See if DWT is available
    {   
...
{
    elapsed_time_tbl[i].start = BSP_REG_DWT_CYCCNT;
}
...
CPU_INT64U  CPU_TS32_to_uSec (CPU_TS32  ts_cnts)
{
    ...
    ts_us = ts_cnts / (CPU_TS_TmrFreq_Hz / DEF_TIME_NBR_uS_PER_SEC);
